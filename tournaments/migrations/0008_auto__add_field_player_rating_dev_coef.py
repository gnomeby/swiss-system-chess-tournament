...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Player.rating_dev_coef'
        db.add_column(u'tournaments_player', 'rating_dev_coef',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Player.rating_dev_coef'
        db.delete_column(u'tournaments_player', 'rating_dev_coef')
    ...
    models = {
        ...
        u'tournaments.player': {
            ...
            'rating_dev_coef': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True'}),
