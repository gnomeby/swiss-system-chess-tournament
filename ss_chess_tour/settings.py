...
SECRET_KEY = '9759c5lbl(=c83xen@b!xfuyzrnopa0wgw(y=%n61*8@s+oe=q'
...
ROOT_URLCONF = 'ss_chess_tour.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'ss_chess_tour.wsgi.application'
